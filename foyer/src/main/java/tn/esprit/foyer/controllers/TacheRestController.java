...
public class TacheRestController {
    ...
    @PostMapping("/addTachesAndAffectToEtudiant/{cinEtudiant}")
    @ResponseBody
    public List<Tache> addTachesAndAffectToEtudiant(@RequestBody List<Tache> taches, @PathVariable("cinEtudiant") Long cinEtudiant) {
        return tacheService.addTachesAndAffectToEtudiant(taches, cinEtudiant);
    }
